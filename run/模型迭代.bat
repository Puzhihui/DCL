...
echo ==================================================
python stat_acc.py --mode %userInput% --imagedata %imagedata% --img_path %img_path% --client %client%

python get_data_from_reviewed.py --mode %userInput% --imagedata %imagedata% --img_path %img_path% --client %client%
