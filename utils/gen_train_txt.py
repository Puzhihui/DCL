...
def glob_img(data_path, f_txt, multi_classes, log_server, data="train"):
...
def generate_txt(cfg, log_server):
    ...
    for train_path in cfg.train_path_list:
        train_dict = glob_img(train_path, f_train, multi_classes, log_server, "train")
    for val_path in cfg.val_path_list:
        val_dict = glob_img(val_path, f_val, multi_classes, log_server, "val")
    f_train.close()
    f_val.close()
